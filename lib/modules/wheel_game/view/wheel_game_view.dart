...
class RestaurantNameDisplay extends StatelessWidget {
  const RestaurantNameDisplay({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
          () => controller.restaurantName.value.isEmpty
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    AppColor.primaryGold.withValues(alpha: 0.9),
                    AppColor.primaryPink.withValues(alpha: 0.9),
                  ],
                ),
